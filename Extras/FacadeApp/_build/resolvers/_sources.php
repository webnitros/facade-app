...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'FacadeApp',
                'description' => 'Default source for files of FacadeApp',
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'FacadeApp_source_default'))) {
